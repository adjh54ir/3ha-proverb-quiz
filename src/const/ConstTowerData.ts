...
export const TOWER_LEVELS = [
	{
		...
		bossImage: require('@/assets/images/boss/boss1_character.png'),
	...
	},
	{
		...
		questions: [], // ← 추가 (사용하지 않으면 빈 배열)
		bossImage: require('@/assets/images/boss/boss2_character.png'),
		requiredScore: 100,
		reward: {
			type: 'costume',
			name: '중급 망토',
	...
	},
	{
		...
		bossImage: require('@/assets/images/boss/boss3_character.png'),
		requiredScore: 300,
	...
	},
	{
		...
		bossImage: require('@/assets/images/boss/boss4_character.png'),
		requiredScore: 600,
		reward: {
			type: 'character',
			name: '황금 도깨비 방망이',
