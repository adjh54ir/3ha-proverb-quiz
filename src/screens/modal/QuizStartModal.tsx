...
export type QuizStartMode = 'meaning' | 'proverb' | 'blank' | 'example';
 ...
 * 퀴즈 시작 안내 공통 팝업
 */
const QuizStartModal = ({ visible, mode, isPracticeMode = false, timeLimit = 40, scorePerCorrect = 10, showHint = true, onStart, onBack }: Props) => {
	const scaleAnim = useRef(new Animated.Value(0.9)).current;
	const opacityAnim = useRef(new Animated.Value(0)).current;
	const meta = mode ? MODE_META[mode] ?? MODE_META.meaning : { title: '속담 퀴즈', desc: '얼마나 알고 있는지 확인해 볼까요?', icon: 'psychology' };
...
const styles = StyleSheet.create({
	overlay: { flex: 1, backgroundColor: 'rgba(15,23,42,0.5)', justifyContent: 'center', alignItems: 'center', padding: scaleWidth(24) },
	card: {
		width: '100%',
	...
	iconCircle: { width: scaleWidth(60), height: scaleWidth(60), borderRadius: scaleWidth(30), backgroundColor: '#EFF6FF', justifyContent: 'center', alignItems: 'center', marginBottom: scaleHeight(14) },
	title: { fontSize: scaledSize(20), fontWeight: '800', color: '#1E293B', marginBottom: scaleHeight(6), textAlign: 'center' },
	desc: { fontSize: scaledSize(14), color: '#64748B', textAlign: 'center', lineHeight: scaleHeight(20), marginBottom: scaleHeight(16) },
	practiceBanner: { flexDirection: 'row', alignItems: 'center', gap: scaleWidth(6), backgroundColor: '#FFF7ED', borderRadius: scaleWidth(10), paddingVertical: scaleHeight(8), paddingHorizontal: scaleWidth(12), marginBottom: scaleHeight(14) },
	practiceText: { fontSize: scaledSize(12), color: '#F97316', fontWeight: '700', flexShrink: 1 },
	infoBox: { width: '100%', backgroundColor: '#F8FAFC', borderRadius: scaleWidth(16), padding: scaleWidth(14), marginBottom: scaleHeight(20) },
	infoRow: { flexDirection: 'row', alignItems: 'center', gap: scaleWidth(10), marginBottom: scaleHeight(10) },
	infoIconChip: { width: scaleWidth(28), height: scaleWidth(28), borderRadius: scaleWidth(9), backgroundColor: '#EFF6FF', justifyContent: 'center', alignItems: 'center' },
	...
	backButton: { flex: 1, backgroundColor: '#F1F5F9', borderRadius: scaleWidth(14), paddingVertical: scaleHeight(14), alignItems: 'center' },
	backButtonText: { fontSize: scaledSize(15), fontWeight: '800', color: '#64748B' },
	startButton: { flex: 1.5, flexDirection: 'row', gap: scaleWidth(4), backgroundColor: '#3B82F6', borderRadius: scaleWidth(14), paddingVertical: scaleHeight(14), alignItems: 'center', justifyContent: 'center' },
