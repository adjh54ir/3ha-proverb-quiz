...
본 개인정보처리방침은 모바일 기기용 **‘속픽: 속담 퀴즈** 애플리케이션(이하 "애플리케이션")에 적용되며, 해당 애플리케이션은 **Contributor9**(이하 "서비스 제공자")에 의해 **무료 서비스**로 제작되었습니다. 본 서비스는 "있는 그대로(AS IS)" 제공됩니다.
...
본 이용약관은 모바일 기기용 애플리케이션인 **‘속픽: 속담 퀴즈**(이하 “애플리케이션”)에 적용되며, 본 애플리케이션은 **Contributor9**(이하 “서비스 제공자”)에 의해 **무료 서비스**로 제공됩니다.
